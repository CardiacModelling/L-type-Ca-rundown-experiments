...
# equation: r_rate = b_0 + b_1 * (log(thold)) + b_3 * (temp_298) + b_2 * (INaCA_On)
b_0, b_1, b_3, b_2 = 0.158795, -0.016373, -0.062213, -0.021030
ci_l_0, ci_u_0 =  0.11984411,  0.197745292
ci_l_1, ci_u_1 = -0.02930387, -0.003442791
ci_l_3, ci_u_3 = -0.07628548, -0.048139628
ci_l_2, ci_u_2 = -0.03490557, -0.007153578
